...
type AccessRole = "super_admin"|"admin"|"standard"|"job_creator";
const ownerUid="TOXwE0xXDlgoL4YqBbrTOGjxCyk1";
const roleLabels:Record<AccessRole,string>={super_admin:"Super Admin",admin:"Admin",standard:"Production Floor",job_creator:"Job Creator"};
