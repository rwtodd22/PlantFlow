...
export type AppSettings = { deadlineHighlighting:boolean; timeDisplayMode:"days"|"hours"; billingAutoDeleteApproved90Days:boolean; showOvertimeOnJobCreation:boolean; showExpectedRouteOnJobCreation:boolean };
...
export const seedState: AppState = {
  settings:{deadlineHighlighting:true,timeDisplayMode:"days",billingAutoDeleteApproved90Days:false,showOvertimeOnJobCreation:false,showExpectedRouteOnJobCreation:false},
  departments:[
