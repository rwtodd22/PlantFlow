...
export type AppSettings = { deadlineHighlighting:boolean; timeDisplayMode:"days"|"hours"; billingAutoDeleteApproved90Days:boolean };
...
export const seedState: AppState = {
  settings:{deadlineHighlighting:true,timeDisplayMode:"days",billingAutoDeleteApproved90Days:false},
  departments:[
